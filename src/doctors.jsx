const doctorsData = [
  ...
  },
  {
    ...
    cv: [
      ...
      { tag: "Current", line: "르셀의원 원장" },
      { tag: "Field", line: "피부·항노화·웰니스 진료" },
    ],
    cvEN: [
      ...
      { tag: "Current", line: "Director, Lecell Clinic" },
      { tag: "Field", line: "Dermatology · Anti-Aging · Wellness" },
    ],
    cvJP: [
      { tag: "学歴", line: "順天郷大学医科大学卒" },
      { tag: "資格", line: "専門医" },
      { tag: "前職", line: "ウリドゥル病院 救急医療センター勤務" },
      { tag: "現職", line: "ルセルクリニック院長" },
      { tag: "専門", line: "皮膚・抗老化・ウェルネス診療" },
    ],
  },
];
