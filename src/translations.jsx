const TRANSLATIONS = {
  ...
  JP: {
    ...
    programs: { sectionLabel: "プログラム", title: "診療", titleEm: "プログラム", desc: "抗老化を軸とした美容外科・皮膚科と幹細胞療法を組み合わせた5つの統合診療カテゴリーです。", data: [
      ...
      { id: "wellness", n: "05", tab: "ウェルネス", h: "Integrative", hEm: "Wellness", ko: "ウェルネス・統合ケア", lede: "肥満クリニックやがん患者向け統合ケアを含む機能医学ベースのウェルネスプログラム。お客様のライフサイクル全般を考慮した長期管理です。", items: [{ ti: "GLP-1肥満クリニック", sub: "代謝体重管理", dur: "30 分" }, { ti: "遺伝子解析", sub: "DNAベース分析", dur: "60 分" }, { ti: "がん患者統合ケア", sub: "腫瘍学的サポートプログラム", dur: "90 分" }, { ti: "機能医学IV", sub: "機能医学インフュージョン", dur: "60 分" }] },
    ] },
